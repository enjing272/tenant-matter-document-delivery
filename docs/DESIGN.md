...
> Design notes for **tenant-matter-document-delivery** — a runnable typescript example that TypeScript matter intake and signed document delivery with one storage bucket per tenant.
...
- **Feature code** — the actual task: tenant-matter-files.
